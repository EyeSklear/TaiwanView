...
// Does NOT expect valid geoJSON polygon geometry: first and last positions should not be equivalent.
    ...
    ModeInterface.prototype.newFeature = function (geojson) {
        ...
        if (type === geojsonTypes.POINT) {
            return new Point$1(this._ctx, geojson);
        }
    ...
    ModeInterface.prototype.isInstanceOf = function (type, feature) {
        if (type === geojsonTypes.POINT) {
            return feature instanceof Point$1;
        }
        if (type === geojsonTypes.LINE_STRING) {
    ...
    function refreshSelectedCoordinates(store, options) {
        var newSelectedCoordinates = store._selectedCoordinates.filter(function (point) {
            return store._selectedFeatureIds.has(point.feature_id);
        });
    ...
    var geojsonExtent = {
        get exports() {
            return geojsonExtentExports;
        },
        set exports(v) {
            geojsonExtentExports = v;
        },
    };
        ...
        switch (t && t.type || null) {
            ...
            case"Feature":
                return t.geometry ? e(t.geometry).map(function (e) {
                    var r = {type: "Feature", properties: JSON.parse(JSON.stringify(t.properties)), geometry: e};
...
//   edge and the poles, such that it couldn't be re-selected and moved back
    ...
    SimpleSelect.onSetup = function (opts) {
        ...
        this.setSelected(state.initiallySelectedFeatureIds.filter(function (id) {
            return this$1$1.getFeature(id) !== undefined;
        }));
        this.fireActionable();
    ...
    SimpleSelect.fireActionable = function () {
        ...
        var multiFeatures = selectedFeatures.filter(
            function (feature) {
                return this$1$1.isInstanceOf('MultiFeature', feature);
            }
        );
