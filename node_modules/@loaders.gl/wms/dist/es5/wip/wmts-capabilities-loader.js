...
var WMTSCapabilitiesLoader = {
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", (0, _parseWmts.parseWMTSCapabilities)(new TextDecoder().decode(arrayBuffer), options));
            case 1:
            case "end":
  ...
  parseTextSync: function parseTextSync(text, options) {
    return (0, _parseWmts.parseWMTSCapabilities)(text, options);
  }
};
