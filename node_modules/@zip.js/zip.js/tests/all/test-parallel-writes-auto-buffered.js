...
const KB = 1024;
const ENTRIES_DATA = [
    {name: "entry #1", blob: getBlob(8.5 * KB)}, {name: "entry #2", blob: getBlob(5.2 * KB)}, {
        name: "entry #3",
        blob: getBlob(4.7 * KB)
    },
    {name: "entry #4", blob: getBlob(2.8 * KB)}, {name: "entry #5", blob: getBlob(1.9 * KB)}, {
        name: "entry #6",
        blob: getBlob(2.2 * KB)
    },
    {name: "entry #7", blob: getBlob(5.1 * KB)}, {name: "entry #8", blob: getBlob(2.6 * KB)}, {
        name: "entry #9",
        blob: getBlob(3.1 * KB)
    }];
const ENTRIES_DATA_PASS2 = [
    {name: "entry #1 (pass #2)", blob: getBlob(3.5 * KB)}, {
        name: "entry #2 (pass #2)",
        blob: getBlob(2.2 * KB)
    }, {name: "entry #3 (pass #2)", blob: getBlob(7.7 * KB)},
    {name: "entry #4 (pass #2)", blob: getBlob(1.3 * KB)}, {
        name: "entry #5 (pass #2)",
        blob: getBlob(5.2 * KB)
    }, {name: "entry #6 (pass #2)", blob: getBlob(4.1 * KB)},
    {name: "entry #7 (pass #2)", blob: getBlob(1.0 * KB)}, {
        name: "entry #8 (pass #2)",
        blob: getBlob(6.2 * KB)
    }, {name: "entry #9 (pass #2)", blob: getBlob(8.4 * KB)}];
