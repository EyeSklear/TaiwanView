 ...
 */
export declare type Store<Id extends string = string, S extends StateTree = {}, G = {}, A = {}> =
 ...
 */
declare type StoreToRefs<SS extends StoreGeneric> =
    ToRefs<StoreState<SS> & PiniaCustomStateProperties<StoreState<SS>>>
