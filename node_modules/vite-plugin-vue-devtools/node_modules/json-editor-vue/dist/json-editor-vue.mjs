...
function It(t) {
  return typeof t == "symbol" || x(t) && z(t) == xn;
}
function Tn(t, r) {
...
var Aa = U(T, "Set");
const St = Aa;
var ar = "[object Map]", Sa = "[object Object]", ir = "[object Promise]", cr = "[object Set]", ur = "[object WeakMap]", fr = "[object DataView]", xa = M(wt), Ta = M(H), Ea = M(At), Pa = M(St), Ia = M(_t), k = z;
(wt && k(new wt(new ArrayBuffer(1))) != fr || H && k(new H()) != ar || At && k(At.resolve()) != ir || St && k(new St()) != cr || _t && k(new _t()) != ur) && (k = function(t) {
  var r = z(t), n = r == Sa ? t.constructor : void 0, e = n ? M(n) : "";
  if (e)
    switch (e) {
      case xa:
        return fr;
...
y[Zr] = y[yi] = y[Ei] = y[Pi] = y[hi] = y[ji] = y[Ii] = y[Ci] = y[$i] = y[ki] = y[Fi] = y[_i] = y[Oi] = y[Hr] = y[wi] = y[Ai] = y[Si] = y[xi] = y[zi] = y[Mi] = y[Ui] = y[Bi] = !0;
y[gi] = y[Jr] = y[Ti] = !1;
function et(t, r, n, e, o, a) {
  ...
  if (d)
    return d;
  a.set(t, i), pi(t) ? t.forEach(function(s) {
    i.add(et(s, r, n, s, t, a));
  }) : ui(t) && t.forEach(function(s, f) {
    i.set(f, et(s, r, n, f, t, a));
  });
  var j = v ? u ? _a : Ot : u ? L : X, m = b ? void 0 : j(t);
  return ce(m || t, function(s, f) {
    m && (f = s, s = t[f]), Er(i, f, et(s, r, n, f, t, a));
  }), i;
}
var Di = 1, Ri = 4;
function Wi(t) {
...
function Kr(t, r, n, e, o, a) {
  ...
  for (a.set(t, r), a.set(r, t); ++l < c; ) {
    var j = t[l], m = r[l];
    if (e)
      var s = i ? e(m, j, l, r, t, a) : e(j, m, l, t, r, a);
    if (s !== void 0) {
      if (s)
        continue;
      p = !1;
    ...
    if (d) {
      if (!Gi(r, function(f, g) {
        if (!qi(d, g) && (j === f || o(j, f, n, e, a)))
          return d.push(g);
      })) {
        p = !1;
        break;
      }
    } else if (!(j === m || o(j, m, n, e, a))) {
      p = !1;
      break;
    }
  }
...
function bc(t, r, n, e, o, a) {
  ...
  for (var s = i; ++l < u; ) {
    ...
    var f = t[p], g = r[p];
    if (e)
      var B = i ? e(g, f, p, r, t, a) : e(f, g, p, t, r, a);
    if (!(B === void 0 ? f === g || o(f, g, n, e, a) : B)) {
      m = !1;
      break;
    }
    s || (s = p == "constructor");
  ...
  if (m && !s) {
    var $ = t.constructor, A = r.constructor;
    $ != A && "constructor" in t && "constructor" in r && !(typeof $ == "function" && $ instanceof $ && typeof A == "function" && A instanceof A) && (m = !1);
  }
...
function hc(t, r, n, e, o, a) {
  ...
  if (!(n & dc)) {
    var d = b && hr.call(t, "__wrapped__"), j = l && hr.call(r, "__wrapped__");
    if (d || j) {
      var m = d ? t.value() : t, s = j ? r.value() : r;
      return a || (a = new w()), o(m, s, n, e, a);
    }
  }
...
function Bc(t, r, n, e, o, a, i) {
  ...
  if (l) {
    var p = O(u), d = !p && Z(u), j = !p && !d && Ut(u);
    b = u, p || d || j ? O(c) ? b = c : Mc(c) ? b = Tr(c) : d ? (l = !1, b = Wr(u, !0)) : j ? (l = !1, b = Gr(u, !0)) : b = [] : Dr(u) || it(u) ? (b = c, it(c) ? b = Uc(c) : (!E(c) || $t(c)) && (b = qr(u))) : l = !1;
  }
...
function D(t, r = {}) {
  ...
  const s = (f) => {
    if (f !== void 0) {
      Yc({ type: n, prop: f, validator: i });
      const g = Dr(f), B = typeof f == "function";
      return j = g, m = B, g ? (f = Wi(f), c ? Wc(f, ($, A) => Jc(A, {
        stripRegexp: /-/g
  ...
  for (let f = 0; f < p.length; f++) {
    const g = p[f];
    if (g !== void 0) {
      f === p.length - 1 ? d = g : b ? d = tu(u ? [g, e] : p, {
        mergeObject: b,
        mergeFunction: l
      }) : l ? d = ru(v ? [g, e] : p, {
        mergeFunction: l
...
function $u(t, r, n) {
  ...
  function d(_) {
    var C = e, V = o;
    return e = o = void 0, v = _, i = t.apply(V, C), i;
  }
  function j(_) {
    return v = _, c = setTimeout(f, r), b ? d(_) : i;
  }
  function m(_) {
    var C = _ - u, V = _ - v, Nt = r - C;
    return l ? Cu(Nt, a - V) : Nt;
  }
  function s(_) {
    var C = _ - u, V = _ - v;
    return u === void 0 || C >= r || C < 0 || l && V >= a;
  }
  function f() {
    var _ = mt();
    if (s(_))
  ...
  function $() {
    return c === void 0 ? i : g(mt());
  }
  function A() {
    var _ = mt(), C = s(_);
    if (e = arguments, o = this, u = _, C) {
      if (c === void 0)
        return j(u);
      if (l)
        return clearTimeout(c), c = setTimeout(f, r), d(u);
    }
    return c === void 0 && (c = setTimeout(f, r)), i;
  }
  return A.cancel = B, A.flush = $, A;
}
const ku = "JsonEditorVue", rt = Pt ? "modelValue" : "value", wr = Pt ? "update:modelValue" : "input", nt = [
  ...
  setup(t, { attrs: r, emit: n, expose: e }) {
    ...
    const o = (m = un()) == null ? void 0 : m.proxy, a = yt(), i = yt(!1), c = yt(!1), u = D([t.mode, ot.mode], {
      ...
      Array.from(nt, (s) => [s, D([t[s], ot[s]])]).filter(
        ([, s]) => s !== void 0
      )
    ), l = $u((s) => {
      if (c.value) {
    ...
    return Y(
      ...
      (s) => {
        ...
        c.value = !0, (f = a.value) == null || f.update(
          [void 0, ""].includes(s) ? { text: "" } : { json: s }
        );
      },
      {
        deep: !0
      ...
      (s) => {
        a.value.updateProps(
          Object.fromEntries(Array.from(s, (f, g) => [nt[g], f]).filter(([, f]) => f !== void 0))
        );
      }
    ), Y(
      () => r,
      (s) => {
        const f = {};
        s.onChange && (f.onChange = l), s.onChangeMode && (f.onChangeMode = p), a.value.updateProps(
          Object.getOwnPropertyNames(f).length > 0 ? D([s, f], {
            type: Object,
            mergeFunction: d
          }) : s
        );
