...
function createLanguageService(host, mods) {
    ...
    function transformFileTextChanges(changes) {
        ...
        if (source) {
            return Object.assign(Object.assign({}, changes), {
                fileName: source.fileName, textChanges: changes.textChanges.map(c => {
    ...
    function transformReferencedSymbol(symbol) {
        ...
        if (definition) {
            ...
            return {
                definition: Object.assign(Object.assign({}, symbol.definition), {
    ...
    function transformDocumentSpanLike(documentSpan) {
        ...
        return Object.assign(Object.assign({}, documentSpan), {
