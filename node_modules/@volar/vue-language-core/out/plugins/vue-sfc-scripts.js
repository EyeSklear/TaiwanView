...
const plugin = () => {
    return {
        ...
        resolveEmbeddedFile(_fileName, sfc, embeddedFile) {
            ...
            if (script) {
                embeddedFile.capabilities = Object.assign(Object.assign({}, language_core_1.FileCapabilities.full), {
                    diagnostic: false, documentFormatting: {
                        initialIndentBracket: ['{', '}'],
                    }, codeAction: false, inlayHint: false
                });
