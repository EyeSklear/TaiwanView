...
function generate(ts, compilerOptions, vueCompilerOptions, sourceTemplate, sourceLang, templateAst, hasScriptSetup, cssScopedClasses = []) {
        ...
        for (const tagName in tagNames) {
            ...
            for (const name of names) {
                for (const tagRange of tagRanges) {
                    ...
                    writePropertyAccess(name, tagRange, Object.assign(Object.assign({}, capabilitiesSet.tagReference), {
                        rename: {
    ...
    function visitNode(node, parentEl) {
        ...
        if (node.type === 0 /* CompilerDOM.NodeTypes.ROOT */) {
            ...
            const leftExpressionRange = value ? {
                start: ((_b = value !== null && value !== void 0 ? value : key) !== null && _b !== void 0 ? _b : index).loc.start.offset,
                end: ((_c = index !== null && index !== void 0 ? index : key) !== null && _c !== void 0 ? _c : value).loc.end.offset
            } : undefined;
    ...
    function writeEvents(node) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                writeCodeWithQuotes(key_2, [prop.arg.loc.start.offset, prop.arg.loc.end.offset], Object.assign(Object.assign({}, capabilitiesSet.attrReference), {
                    rename: {
                        normalize(newName) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                if (!prop.arg) {
                    ...
                    writePropName(propName, isStatic, [prop.arg.loc.start.offset, prop.arg.loc.start.offset + attrNameText.length], Object.assign(Object.assign({}, getCaps(capabilitiesSet.attr)), {
                        rename: {
                    ...
                    writePropName(propName, isStatic, [prop.arg.loc.start.offset, prop.arg.loc.end.offset], Object.assign(Object.assign({}, getCaps(capabilitiesSet.attr)), {
                        rename: {
                            normalize: shared_1.camelize,
                            apply: getRenameApply(attrNameText),
                        }
                ...
                if (prop.arg && attrNameText !== propName) {
                    writePropStart(isStatic);
                    writePropName(attrNameText, isStatic, [prop.arg.loc.start.offset, prop.arg.loc.end.offset], Object.assign(Object.assign({}, getCaps(capabilitiesSet.attr)), {
                        rename: {
                            normalize: shared_1.camelize,
                            apply: getRenameApply(attrNameText),
                        }
                ...
                writePropName(propName, true, [prop.loc.start.offset, prop.loc.start.offset + prop.name.length], Object.assign(Object.assign({}, getCaps(capabilitiesSet.attr)), {
                    rename: {
                        normalize: shared_1.camelize,
                ...
                if (attrNameText !== propName) {
                    writePropStart(true);
                    writePropName(attrNameText, true, prop.loc.start.offset, Object.assign(Object.assign({}, getCaps(capabilitiesSet.attr)), {
                        rename: {
                            normalize: shared_1.camelize,
                            apply: getRenameApply(prop.name),
                        }
            ...
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                if (isStatic) {
                    ...
                    if (!compilerOptions.noPropertyAccessFromIndexSignature) {
                        ...
                        codeGen.push(`[`);
                        writeCodeWithQuotes(slotName, argRange, Object.assign(Object.assign({}, capabilitiesSet.slotName), {completion: !!prop.arg}));
                        codeGen.push(`]`);
                    }
                } else {
                    codeGen.push(`[`);
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                codeGen.push([
                    ...
                    Object.assign(Object.assign({}, capabilitiesSet.noDiagnostic), {
                        completion: {
    ...
    function writeSlots(node, startTagOffset) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                writeObjectProperty(prop.arg.content, [prop.arg.loc.start.offset, prop.arg.loc.end.offset], Object.assign(Object.assign({}, capabilitiesSet.attrReference), {
                    rename: {
                        normalize: shared_1.camelize,
                ...
                writeObjectProperty(prop.name, prop.loc.start.offset, Object.assign(Object.assign({}, capabilitiesSet.attr), {
                    rename: {
                        normalize: shared_1.camelize,
                        apply: getRenameApply(prop.name),
                    }
