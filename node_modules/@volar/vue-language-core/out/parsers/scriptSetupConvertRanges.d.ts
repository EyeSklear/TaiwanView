...
export declare function parseUnuseScriptSetupRanges(ts: typeof import('typescript/lib/tsserverlibrary'), ast: ts.SourceFile, vueCompilerOptions: VueCompilerOptions): {
    imports: TextRange[];
    defineProps: {
        range: TextRange;
