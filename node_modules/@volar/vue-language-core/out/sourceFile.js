...
class VueFile {
    ...
    constructor(fileName, snapshot, ts, plugins) {
        ...
        this.mappings = [];
        // refs
        this.sfc = (0, reactivity_1.reactive)(Object.assign({
            template: null,
            script: null,
            scriptSetup: null,
            styles: [],
        ...
        this._embeddedFiles = (0, reactivity_1.computed)(() => {
            ...
            for (const {file, snapshot, mappings} of remain) {
                embeddedFiles.push(Object.assign(Object.assign({}, file), {
                    snapshot,
            ...
            function consumeRemain() {
                for (let i = remain.length - 1; i >= 0; i--) {
                    ...
                    if (!file.parentFileName) {
                        ...
                        if (parent) {
                            parent.embeddedFiles.push(Object.assign(Object.assign({}, file), {
                                snapshot,
                                mappings, embeddedFiles: []
                            }));
                            remain.splice(i, 1);
