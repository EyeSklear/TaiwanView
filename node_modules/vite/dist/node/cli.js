...
import {
    A as picocolorsExports,
    B as bindShortcuts,
    w as createLogger,
    h as resolveConfig
} from './chunks/dep-3007b26d.js';
...
cli
    ...
    .action(async (root, options) => {
        ...
        // is ok here
        const {createServer} = await import('./chunks/dep-3007b26d.js').then(function (n) {
            return n.E;
        });
        try {
...
cli
    ...
    .action(async (root, options) => {
        filterDuplicateOptions(options);
        const {build} = await import('./chunks/dep-3007b26d.js').then(function (n) {
            return n.D;
        });
...
cli
    ...
    .action(async (root, options) => {
        filterDuplicateOptions(options);
        const {optimizeDeps} = await import('./chunks/dep-3007b26d.js').then(function (n) {
            return n.C;
        });
        try {
...
cli
    ...
    .action(async (root, options) => {
        filterDuplicateOptions(options);
        const {preview} = await import('./chunks/dep-3007b26d.js').then(function (n) {
            return n.F;
        });
        try {
