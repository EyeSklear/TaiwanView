...
export type ParallelPluginHooks = Exclude<keyof FunctionPluginHooks | AddonHooks,
...
export type AwaitedEventListener<T extends { [event: string]: (...parameters: any) => any },
